...
<body>
    ...
    $cor= $conn->real_escape_string($_POST['texto']); // prepara a string recebida para ser utilizada em comando SQL
   ...
   echo $target_file;
    ...
    $sql = "INSERT INTO usuarios(Nome,Senha,Foto,Sobrenome,Email,Celular,Genero,texto) VALUES ('$nome','$md5Senha','$imagem_binaria','$sobrenome','$email','$celular','$genero','$cor')";
