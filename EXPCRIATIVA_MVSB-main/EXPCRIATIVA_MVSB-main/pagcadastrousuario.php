                ...
                <form action='http://localhost/EXPCRIATIVA_MVSB-MAIN/cadastro.php' enctype="multipart/form-data" method="POST"   id="registration-form" onsubmit="return validateForm()">
                    ...
                    <div class="input-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" style="position:relative;left:510px;">
                                <div class="form-group" >
                                    <label for="texto">Cor favorita</label>
                                    <input id="texto" type="texto" class="form-control" name="texto" placeholder="Digite sua cor favorita..." required>
                                </div>
                            </div>
                        </div>
                    </div>
