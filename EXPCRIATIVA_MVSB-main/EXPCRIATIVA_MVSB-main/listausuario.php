...
<nav class="navbar navbar-inverse" style="color: rgb(212, 218, 223);height:70px;z-index:101;">
    ...
    <div class="container" style="height: 700px; position: absolute;top: 50px;">              
        ...
        <div class="inputform" style="background-color:#C4B5B5;width:250px;height:280px;position:relative;top:45px;left:50px;">
...
echo '<thead>';
echo '<tr>';
echo '<th colspan="10" class=" table-title">Lista de Usuários</th>'; // Título da tabela
echo '</tr>';
echo '<tr>';
echo '<th>ID</th>';
echo '<th>Nome</th>';
