...
<nav class="navbar navbar-inverse" style="height:100px;color: rgb(212, 218, 223);">
    ...
    <div class="container" style="height: 700px; position: absolute;top: 100px;">        
        ...
        <input style=" position: relative;top:30px;left: 25px;" type="text" id="filtro-nome" placeholder="Filtrar por ID" onkeyup="filtrarTabela('nome')"> 
<input style=" width:175px;height:30px;position: relative;top:40px;left: 23px;" type="text" id="filtro-estrelas" placeholder="Filtrar por Nome" onkeyup="filtrarTabela('estrelas')"> 
</div>
</div>
...
$sql = "SELECT ID, Nome, Endereco,CNPJ FROM estabelecimentos";
$result = $conn->query($sql);
...
echo '<thead>';
echo '<tr>';
echo '<th colspan="10" class="table-title">Lista de Estabelecimentos Cadastrados</th>'; // Título da tabela
echo '</tr>';
echo '<tr>';
echo '<th>ID</th>';
echo '<th>Nome</th>';
...
?>
    ...
    for (var i = 0; i < tr.length; i++) {
        ...
        var tdEstrelas = tr[i].getElementsByTagName("td")[1]; // Coluna de Estrelas
