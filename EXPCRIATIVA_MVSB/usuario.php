...
function exibirModal($titulo, $mensagem) {
  echo "
  <div id='cadastroModal' class='w3-modal' style='display: block;'>
      <div class='w3-modal-content w3-card-4 w3-animate-zoom'>
          <header class='w3-container w3-teal'>
              <span onclick='document.getElementById(\"cadastroModal\").style.display = \"none\";' id='fecharModal' class='w3-button w3-large w3-display-topright'>&times;</span>
...
if ($_SESSION['nao_autenticado'] == 0 && isset($_SESSION['nao_autenticado']) ){
  exibirModal('Confirmação de Login', 'Você está logado como usuário comum!');
    if($_SESSION['autadm']){
