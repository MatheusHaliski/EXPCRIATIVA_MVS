...
$sql = "SELECT ID, Nome, Senha, Foto, usuarioadm FROM usuarios";
        ...
        <div class="col-md-9 col-ms-4 form">
            ...
            <table class="table table-responsive table-bordered table-white">
                ...
                <tbody id="usuario-list">
                    ...
                    <tr>
                    <td>
                            <form action="http://localhost/EXPCRIATIVA_MVSB-MAIN/excluirusuario.php" method="POST" style="display:inline;">
                        ...
                        <td><img style="width:40px;height:40px;" src="data:image/jpeg;base64,<?php echo base64_encode($usuario['Foto']); ?>"></td>
                        <td style="text-align:center">
                            <?php if ($usuario['usuarioadm']): ?>
                            <img style="width:40px;height:40px;" src="right.JPG">
                            <?php else: ?>
                            <img style="width:40px;height:40px;" src="wrong.JPG">
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
