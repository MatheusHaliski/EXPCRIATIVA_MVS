...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE usuarios SET Nome='$nome', Senha=MD5('$senha'), Foto='$imagem_binaria',Sobrenome='$sobrenome',Genero='$genero',Celular='$celular',Email='$email',usuarioadm='$tipo_usuario' WHERE Nome='$nome_usu' AND Senha=MD5('$senha_usu')";
