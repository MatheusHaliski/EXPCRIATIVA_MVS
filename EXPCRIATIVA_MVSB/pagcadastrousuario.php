<?php
session_start();
$selectedValue = isset($_SESSION['autadm']) ? $_SESSION['autadm'] : 0;
?>
<!DOCTYPE html>
<html lang="pt-br">
...
?> 
      ...
      <div class="collapse navbar-collapse" id="myNavbar" style="background-color: #f8f7f7;font-size: large;">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="http://localhost/EXPCRIATIVA_MVSB-MAIN/pagloginuser.php" style="background-color: #f8f7f7;color: #000;">Login</a></li>
    ...
    <div class="container" style="height: 850px; position: relative;top: -20px;">
        <div class="row">
            ...
            <div class="col-md-6">
                <div >
                <label for="usuarioadm">Selecione seu tipo de usuário:</label>
        <select id="usuarioadm" name="usuarioadm" required onchange="if (this.value=='1'){exibirModal('Usuário Administrador:','O usuário administrador pode fazer tudo que um usuário comum faz além de também poder visualizar e excluir uma avaliação da lista de avaliações, visualizar e excluir um usuário da lista de usuários cadastrados, e também cadastrar um novo estabelecimento para que possa ser avaliado.')}else{exibirModal('Usuário Comum:','O usuário comum pode apenas avaliar estabelecimentos cadastrados, editar seu perfil e visualizar listagem de avaliações.')}">
